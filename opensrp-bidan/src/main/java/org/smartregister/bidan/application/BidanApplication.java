...
public class BidanApplication extends DrishtiApplication {
    ...
    private static String[] getFtsTables() {
        return new String[]{org.smartregister.bidan.constant.BidanConstants.PATIENT_TABLE_NAME};
    }
    ...
    private void setUpEventHandling() {
        ...
        try {
            ...
            EventBus.builder().addIndex(new org.smartregister.bidan.TBREventBusIndex()).installDefaultEventBus();
