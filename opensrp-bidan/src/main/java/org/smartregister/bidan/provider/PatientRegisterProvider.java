...
import static org.smartregister.bidan.constant.BidanConstants.REGISTER_COLUMNS.DIAGNOSIS;
...
import static org.smartregister.bidan.constant.BidanConstants.VIEW_CONFIGS.POSITIVE_REGISTER_ROW;
...
public class PatientRegisterProvider implements SmartRegisterCLientsProviderForCursorAdapter {
    ...
    private boolean populateXpertResult(Map<String, String> testResults, TbrSpannableStringBuilder stringBuilder, boolean withOtherResults) {
        if (testResults.containsKey(org.smartregister.bidan.constant.BidanConstants.RESULT.MTB_RESULT)) {
            stringBuilder.append(withOtherResults ? "Xpe " : "MTB ");
            String mtbResult = testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.MTB_RESULT);
            ...
            } else if (testResults.containsKey(org.smartregister.bidan.constant.BidanConstants.RESULT.RIF_RESULT)) {
                stringBuilder.append(withOtherResults ? "/" : "\nRIF ");
                processXpertResult(testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.RIF_RESULT), stringBuilder);
            }
            return true;
        }
        return false;
    ...
    private void populateResultsColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView details = view.findViewById(R.id.result_details);
        details.setText("");
    ...
    private void populateResultsColumn(CommonPersonObjectClient pc, SmartRegisterClient client, TbrSpannableStringBuilder stringBuilder, boolean singleResult, Long baseline, View button, TextView details) {
        ...
        populateSmearResult(stringBuilder, testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.TEST_RESULT), hasXpert, false);
        populateCultureResults(stringBuilder, testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.CULTURE_RESULT));
        populateXrayResults(stringBuilder, testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.XRAY_RESULT));
    ...
    private void populateSmearResultsColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView results = view.findViewById(R.id.smr_result_details);
        ...
        populateSmearResult(stringBuilder, testResults.get(org.smartregister.bidan.constant.BidanConstants.RESULT.TEST_RESULT), false, true);
        if (stringBuilder.length() > 0) {
    ...
    private void populateXpertResultsColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView results = view.findViewById(R.id.xpert_result_details);
        attachOnclickListener(results, client);
    ...
    private void populateIntreatmentResultsColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        TbrSpannableStringBuilder stringBuilder = new TbrSpannableStringBuilder();
        TextView results = view.findViewById(R.id.intreatment_details);
    ...
    private void populateFollowupScheduleColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView followupText = view.findViewById(R.id.followup_text);
    ...
    private void populateSmearScheduleColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView followupText = view.findViewById(R.id.smr_schedule_text);
        attachOnclickListener(followup, client);
    ...
    private void populateBaselineColumn(CommonPersonObjectClient pc, SmartRegisterClient client, View view) {
        ...
        TextView results = view.findViewById(R.id.baseline_details);
        long baseline = 0l;
