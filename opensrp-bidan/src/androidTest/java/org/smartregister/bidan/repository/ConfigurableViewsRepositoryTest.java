...
public class ConfigurableViewsRepositoryTest {
    ...
    private TbrRepositoryShadow repositoryShadow = new TbrRepositoryShadow(BidanApplication.getInstance().getApplicationContext(), BidanApplication.getInstance().getContext());
