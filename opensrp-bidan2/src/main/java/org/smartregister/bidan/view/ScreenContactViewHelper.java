...
public class ScreenContactViewHelper {
    ...
    public ScreenContactViewHelper(final Context context, View frameView, Contact screenContactData) {
        ...
        FrameLayout frameLayoutTemplate = frameView.findViewById(R.id.clientContactFrameLayout);
        if (frameLayoutTemplate != null) {
            ...
            //Initials TextView
            TextView contactViewInitialsTemplate = frameView.findViewById(R.id.clientContactTextView);
            ...
            String fullname = screenContactData.getFirstName() != null ? screenContactData.getFirstName() + BidanConstants.CHAR.SPACE + screenContactData.getLastName() : screenContactData.getFirstName();
            initialsTextView.setText(Utils.getInitials(fullname));

            if (screenContactData.getGender().equals(BidanConstants.GENDER.FEMALE)) {
            ...
            } else if (screenContactData.getGender().equals(BidanConstants.GENDER.MALE)) {
            ...
            } else if (screenContactData.getGender().equals(BidanConstants.GENDER.TRANSGENDER)) {
            ...
            ImageView indicatorImageViewTemplate = frameView.findViewById(R.id.clientContactIndicatorImageView);
            ...
            if (screenContactData.getStage().equals(BidanConstants.ScreenStage.SCREENED)) {
                ...
                if (screenContactData.getStage().equals(BidanConstants.ScreenStage.PRESUMPTIVE)) {
                    indicatorImageView.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_indicator_screened));
                } else if (screenContactData.getStage().equals(BidanConstants.ScreenStage.POSITIVE)) {
                    indicatorImageView.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_indicator_diagnosed));
                } else if (screenContactData.getStage().equals(BidanConstants.ScreenStage.IN_TREATMENT)) {
            ...
            if (screenContactData.isIndex()) {
                ...
                TextView contactViewIndexTemplate = frameView.findViewById(R.id.clientIndexContactTextView);
