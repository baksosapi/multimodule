...
public class PresumptivePatientDetailsFragment extends BasePatientDetailsFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activity.getSupportActionBar().setTitle(activity.getIntent().getStringExtra(BidanConstants.INTENT_KEY.REGISTER_TITLE));
        setupViews(rootView);
        return rootView;
    }
    ...
    protected String getViewConfigurationIdentifier() {
        return BidanConstants.CONFIGURATION.PATIENT_DETAILS_PRESUMPTIVE;
    }
