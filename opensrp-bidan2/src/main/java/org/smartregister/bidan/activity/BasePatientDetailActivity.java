...
public abstract class BasePatientDetailActivity extends BaseActivity implements DisplayFormListener {
    ...
    protected String[] buildFormNameList() {
        ...
        formNames.add(org.smartregister.bidan.constant.BidanConstants.FORM.RESULT_GENE_EXPERT);
        formNames.add(org.smartregister.bidan.constant.BidanConstants.FORM.RESULT_SMEAR);
        formNames.add(org.smartregister.bidan.constant.BidanConstants.FORM.RESULT_CHEST_XRAY);
        formNames.add(org.smartregister.bidan.constant.BidanConstants.FORM.RESULT_CULTURE);
        formNames.add(org.smartregister.bidan.constant.BidanConstants.FORM.DIAGNOSIS);
    ...
    public void goToPatientDetailActivity(org.smartregister.bidan.constant.BidanConstants.ScreenStage viewConfigurationIdentifier, Map<String, String> patientDetails) {
        Intent intent = null;
        ...
        intent.putExtra(org.smartregister.bidan.constant.BidanConstants.INTENT_KEY.REGISTER_TITLE, registerTitle);
        intent.putExtra(org.smartregister.bidan.constant.BidanConstants.INTENT_KEY.PATIENT_DETAIL_MAP, (HashMap) patientDetails);
        intent.putExtra(org.smartregister.bidan.constant.BidanConstants.KEY.TBREACH_ID, patientDetails.get(org.smartregister.bidan.constant.BidanConstants.KEY.PARTICIPANT_ID));
